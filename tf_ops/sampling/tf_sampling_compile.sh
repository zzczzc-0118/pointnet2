...
# TF2.4
g++ -std=c++11 tf_sampling.cpp tf_sampling_g.cu.o -o tf_sampling_so.so -shared -fPIC -I /usr/local/lib/python3.8/dist-packages/tensorflow/include -I /usr/local/cuda-11.8/include -I /usr/local/lib/python3.8/dist-packages/tensorflow/include/external/nsync/public -lcudart -L /usr/local/cuda-11.8/lib64/ -L /usr/local/lib/python3.8/dist-packages/tensorflow -ltensorflow_framework -O2 -D_GLIBCXX_USE_CXX11_ABI=0